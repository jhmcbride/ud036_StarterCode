""" Stores the info of the movies and runs fresh_tomatoes - which
generates the webpage to display the content."""
...
city_of_god = media.Movie("City of God",
                          ...
                          "https://upload.wikimedia.org/\
                          wikipedia/en/1/10/CidadedeDeus.jpg",
...
life_is_beautiful = media.Movie("Life is Beautiful",
                                ...
                                "https://upload.wikimedia.org/\
                                wikipedia/en/thumb/7/7c/Vitaebella.jpg/\
                                220px-Vitaebella.jpg",
                                "https://www.youtube.com/watch?v=zqAVwCK4r2Q")

boy = media.Movie("boy",
                  "A kid growing up with no father finally meets his hero",
                  "https://upload.wikimedia.org/\
                  wikipedia/en/thumb/c/ca/Boy2010movieposter.jpg/\
                  220px-Boy2010movieposter.jpg",
                  "https://www.youtube.com/watch?v=Qpu0p5ldDS4")

baby_driver = media.Movie("Baby Driver",
                          "A young man learns hard lessons\
                          in his life of crime",
                          "https://upload.wikimedia.org/\
                          wikipedia/en/8/8e/Baby_Driver_poster.jpg",
...
"""Runs fresh_tomatoes.py, which generates a webpage
